...
import com.nihir.tasks.repos.TaskRepo;
import com.nihir.tasks.services.TaskService;
...
public class TaskServiceImpl implements TaskService {
    ...
    public Optional<Task> getTaskById(UUID taskListId, UUID taskId) {
        return taskRepository.findByIdAndTaskListId(taskListId, taskId);
    }
    ...
    public Task updateTask(UUID taskListId, UUID taskId, Task task) {
        ...
        Task existingTask = taskRepository.findByIdAndTaskListId(taskListId, taskId)
